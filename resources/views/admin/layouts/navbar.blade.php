...
<meta content="Codescandy" name="author">
  ...
  <!-- Favicon icon-->
<link class="apple-touch-icon" sizes="57x57" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-57x57.png') }}" />
<link class="apple-touch-icon" sizes="60x60" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-60x60.png') }}" />
<link class="apple-touch-icon" sizes="72x72" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-72x72.png') }}" />
<link class="apple-touch-icon" sizes="76x76" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-76x76.png') }}" />
<link class="apple-touch-icon" sizes="114x114" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-114x114.png') }}" />
<link class="apple-touch-icon" sizes="120x120" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-120x120.png') }}" />
<link class="apple-touch-icon" sizes="144x144" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-144x144.png') }}" />
<link class="apple-touch-icon" sizes="152x152" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-152x152.png') }}" />
<link class="apple-touch-icon" sizes="180x180" href="{{ asset('dasher/dash/assets/images/favicon/apple-icon-180x180.png') }}" />
<link rel="icon" type="image/png" sizes="192x192" href="{{ asset('dasher/dash/assets/images/favicon/android-icon-192x192.png') }}" />
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('dasher/dash/assets/images/favicon/favicon-32x32.png') }}" />
<link rel="icon" type="image/png" sizes="96x96" href="{{ asset('dasher/dash/assets/images/favicon/favicon-96x96.png') }}" />
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('dasher/dash/assets/images/favicon/favicon-16x16.png') }}" />

<meta name="msapplication-TileColor" content="#ffffff" />
<meta name="msapplication-TileImage" content="{{ asset('dasher/dash/assets/images/favicon/ms-icon-144x144.png') }}" />
...
<link rel="stylesheet" href="{{ asset('dasher/dash/assets/libs/%40tabler/icons-webfont/tabler-icons.min.css') }}" />
    ...
    <div id="miniSidebar" style="top: 60px">
      <div class="brand-logo">
        <a class='d-none d-md-flex align-items-center gap-2 text-decoration-none py-4 px-3' href='#'>
          <img src="" />
          <span class="fw-bold fs-4 text-dark site-logo-text" style="left: 10px; top: 100px">Suivi Pénitencier </span>
        </a>
      </div>
      ...
      <ul class="navbar-nav flex-column">
        <li class="nav-item">
          <a class='nav-link active bg-light text-primary' href='{{ route('admin.dashboard') }}'>
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-layout-dashboard"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4h6v8h-6z" /><path d="M4 16h6v4h-6z" /><path d="M14 12h6v8h-6z" /><path d="M14 4h6v4h-6z" /></svg>
            </span> 
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-users"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>
            </span>
        ...
        <li class="nav-item">
          <a class='nav-link' href='{{ route('admin.sortie.listes') }}'>
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-calendar-due"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 5m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M12 16l1 1l3 -3" /></svg>
            </span>
        ...
        <li class="nav-item">
          <a class='nav-link' href='{{ route('admin.deces.listes') }}'>
            <span class="nav-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icon-tabler-file-alert"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" /><path d="M12 17l.01 0" /><path d="M12 11l0 3" /></svg>
            </span>
    ...
    <div class="d-flex align-items-center justify-content-between bg-white shadow-sm rounded-3 px-4 py-2 mt-2">
      <div class="d-flex align-items-center gap-2">
        @php
          ...
          $badgeClass = $typePrison === 'femme' ? 'bg-danger-subtle text-danger' : 'bg-primary-subtle text-primary';
        @endphp
