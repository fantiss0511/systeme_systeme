    ...
    (function () {
        ...
        (document.getElementById("chartGraphics") &&
            ...
            document.getElementById("salesBygender") &&
                ...
                new ApexCharts(
                    document.querySelector("#salesBygender"),
                    e,
                ).render()),
            document.getElementById("leadWonLoss") &&
                ...
                new ApexCharts(
                    document.querySelector("#leadWonLoss"),
                    e,
                ).render()),
            document.getElementById("chartCompany") &&
                ...
                new ApexCharts(
                    document.querySelector("#chartCompany"),
                    e,
                ).render()),
            ...
            document.getElementById("contactSource") &&
                ...
                new ApexCharts(
                    document.querySelector("#contactSource"),
                    e,
                ).render()),
            ...
            document.getElementById("userByCountry") &&
                ((e = {
                    ...
                    responsive: [
                        { breakpoint: 480, options: { chart: { width: 400 } } },
                    ],
                    legend: {
                        position: "bottom",
                        markers: {
            ...
            document.getElementById("trafficSummary") &&
                ((e = {
                    ...
                    plotOptions: {
                        bar: { columnWidth: "50%", horizontal: !1 },
                    },
                    dataLabels: { enabled: !1 },
                    fill: { opacity: 1 },
                    markers: {
                    ...
                    series: [
                        {
                            name: "Web",
                            data: [
                                11, 20, 20, 20, 20, 11, 11, 20, 20, 10, 12, 12,
                                15, 18, 22, 16, 18, 16, 14, 11, 18, 24, 29, 51,
                                40, 47, 23, 26, 50, 26, 41, 22, 46, 47, 81, 46,
                                16,
                            ],
                        },
                        {
                            name: "Social",
                            data: [
                                2, 5, 4, 3, 3, 1, 4, 7, 5, 1, 2, 5, 3, 2, 6, 7,
                        ...
                        },
                        {
                            name: "Other",
                            data: [
                                2, 9, 1, 7, 8, 3, 6, 5, 5, 4, 6, 4, 1, 9, 3, 6,
            ...
            document.getElementById("subscribeChart") &&
                ((e = {
                    ...
                    plotOptions: {
                        bar: { columnWidth: "35%", horizontal: !1 },
                    },
                    dataLabels: { enabled: !1 },
                    fill: { opacity: 1 },
                    series: [
                        {
                            ...
                            data: [
                                30, 42, 56, 46, 30, 22, 42, 36, 58, 69, 45, 55,
                            ],
                        },
                        {
                            name: "Trial Started",
                            data: [
                                11, 30, 40, 60, 50, 45, 85, 30, 45, 60, 80, 20,
                            ],
                        },
                        {
                            name: "Unsubscribed",
                            data: [
                                22, 42, 36, 58, 69, 45, 55, 11, 20, 20, 10, 45,
                            ],
                        },
                    ],
                    tooltip: { theme: "dark" },
            ...
            document.getElementById("dealsRep") &&
                ((e = {
                    series: [
                        { name: "Deals Rep", data: [8, 10, 12, 18, 29, 35] },
                    ],
                    chart: { type: "bar", height: 350, toolbar: { show: !1 } },
                    colors: ["#ffac82"],
                    grid: {
                ...
                new ApexCharts(
                    document.querySelector("#dealsRep"),
                    e,
                ).render()),
